...
function Support() {
    function SkillsCarousel() {
        ...
        // const skillItems = skills.map((skill) => (
        //     <Carousel.Item id="caritem" key={skill.id}>
        //         <img className="d-block w-100" src={skill.imageUrl} alt="First slide" />
        //         <Carousel.Caption>
        //             <h3>{skill.name}</h3>
